/**
 * Source copied from: net/balusc/util/DateUtil.java
 *
...
public final class Dates {
    ...
    static {
        ...
        put(map, "^\\d{8}$", "yyyyMMdd");
        put(map, "^\\d{1,2}-\\d{1,2}-\\d{4}$", "dd-MM-yyyy");
        put(map, "^\\d{4}-\\d{1,2}-\\d{1,2}$", "yyyy-MM-dd");
        put(map, "^\\d{1,2}/\\d{1,2}/\\d{4}$", "MM/dd/yyyy");
        put(map, "^\\d{4}/\\d{1,2}/\\d{1,2}$", "yyyy/MM/dd");
        put(map, "^\\d{1,2}\\s[a-z]{3}\\s\\d{4}$", "dd MMM yyyy");
        put(map, "^\\d{1,2}\\s[a-z]{4,}\\s\\d{4}$", "dd MMMM yyyy");
        put(map, "^\\d{12}$", "yyyyMMddHHmm");
        put(map, "^\\d{8}\\s\\d{4}$", "yyyyMMdd HHmm");
        put(map, "^\\d{1,2}-\\d{1,2}-\\d{4}\\s\\d{1,2}:\\d{2}$", "dd-MM-yyyy HH:mm");
        put(map, "^\\d{4}-\\d{1,2}-\\d{1,2}\\s\\d{1,2}:\\d{2}$", "yyyy-MM-dd HH:mm");
        put(map, "^\\d{1,2}/\\d{1,2}/\\d{4}\\s\\d{1,2}:\\d{2}$", "MM/dd/yyyy HH:mm");
        put(map, "^\\d{4}/\\d{1,2}/\\d{1,2}\\s\\d{1,2}:\\d{2}$", "yyyy/MM/dd HH:mm");
        put(map, "^\\d{1,2}\\s[a-z]{3}\\s\\d{4}\\s\\d{1,2}:\\d{2}$", "dd MMM yyyy HH:mm");
        put(map, "^\\d{1,2}\\s[a-z]{4,}\\s\\d{4}\\s\\d{1,2}:\\d{2}$", "dd MMMM yyyy HH:mm");
        put(map, "^\\d{14}$", "yyyyMMddHHmmss");
        put(map, "^\\d{8}\\s\\d{6}$", "yyyyMMdd HHmmss");
        put(map, "^\\d{1,2}-\\d{1,2}-\\d{4}\\s\\d{1,2}:\\d{2}:\\d{2}$", "dd-MM-yyyy HH:mm:ss");
        put(map, "^\\d{4}-\\d{1,2}-\\d{1,2}\\s\\d{1,2}:\\d{2}:\\d{2}$", "yyyy-MM-dd HH:mm:ss");
        put(map, "^\\d{1,2}/\\d{1,2}/\\d{4}\\s\\d{1,2}:\\d{2}:\\d{2}$", "MM/dd/yyyy HH:mm:ss");
        put(map, "^\\d{4}/\\d{1,2}/\\d{1,2}\\s\\d{1,2}:\\d{2}:\\d{2}$", "yyyy/MM/dd HH:mm:ss");
        put(map, "^\\d{1,2}\\s[a-z]{3}\\s\\d{4}\\s\\d{1,2}:\\d{2}:\\d{2}$", "dd MMM yyyy HH:mm:ss");
        put(map, "^\\d{1,2}\\s[a-z]{4,}\\s\\d{4}\\s\\d{1,2}:\\d{2}:\\d{2}$", "dd MMMM yyyy HH:mm:ss");
        DATE_FORMAT_REGEXPS = Collections.unmodifiableMap(map);
    };
	...
	private static void put(Map<String, String> map, String regexp, String dateFormat) {
		map.put(regexp, dateFormat);
	}
    ...
    public static Date addYears(Date date, int years) {
        Calendar calendar = toCalendar(date);
        Calendars.addYears(calendar, years);
    ...
    public static Date addMonths(Date date, int months) {
        Calendar calendar = toCalendar(date);
        Calendars.addMonths(calendar, months);
        return calendar.getTime();
    }
    ...
    public static Date addDays(Date date, int days) {
        Calendar calendar = toCalendar(date);
        Calendars.addDays(calendar, days);
        return calendar.getTime();
    }
    ...
    public static Date addHours(Date date, int hours) {
        Calendar calendar = toCalendar(date);
        Calendars.addHours(calendar, hours);
        return calendar.getTime();
    }
    ...
    public static Date addMinutes(Date date, int minutes) {
        Calendar calendar = toCalendar(date);
        Calendars.addMinutes(calendar, minutes);
        return calendar.getTime();
    }
    ...
    public static Date addSeconds(Date date, int seconds) {
        Calendar calendar = toCalendar(date);
        Calendars.addSeconds(calendar, seconds);
        return calendar.getTime();
    }
    ...
    public static Date addMillis(Date date, int millis) {
        Calendar calendar = toCalendar(date);
        Calendars.addMillis(calendar, millis);
        return calendar.getTime();
    }
    ...
    public static boolean sameYear(Date one, Date two) {
        return Calendars.sameYear(toCalendar(one), toCalendar(two));
    }
    ...
    public static boolean sameMonth(Date one, Date two) {
        return Calendars.sameMonth(toCalendar(one), toCalendar(two));
    }
    ...
    public static boolean sameDay(Date one, Date two) {
        return Calendars.sameDay(toCalendar(one), toCalendar(two));
    }
    ...
    public static boolean sameHour(Date one, Date two) {
        return Calendars.sameHour(toCalendar(one), toCalendar(two));
    }
    ...
    public static boolean sameMinute(Date one, Date two) {
        return Calendars.sameMinute(toCalendar(one), toCalendar(two));
    }
    ...
    public static boolean sameSecond(Date one, Date two) {
        return Calendars.sameSecond(toCalendar(one), toCalendar(two));
    }
    ...
    public static int elapsedYears(Date before, Date after) {
        return Calendars.elapsedYears(toCalendar(before), toCalendar(after));
    }
    ...
    public static int elapsedMonths(Date before, Date after) {
        return Calendars.elapsedMonths(toCalendar(before), toCalendar(after));
    }
    ...
    public static int elapsedDays(Date before, Date after) {
        return Calendars.elapsedDays(toCalendar(before), toCalendar(after));
    }
    ...
    public static int elapsedHours(Date before, Date after) {
        return Calendars.elapsedHours(toCalendar(before), toCalendar(after));
    }
    ...
    public static int elapsedMinutes(Date before, Date after) {
        return Calendars.elapsedMinutes(toCalendar(before), toCalendar(after));
    }
    ...
    public static int elapsedSeconds(Date before, Date after) {
        return Calendars.elapsedSeconds(toCalendar(before), toCalendar(after));
    }
    ...
    public static long elapsedMillis(Date before, Date after) {
        return Calendars.elapsedMillis(toCalendar(before), toCalendar(after));
    }
    ...
    public static int[] elapsedTime(Date before, Date after) {
        return Calendars.elapsedTime(toCalendar(before), toCalendar(after));
    }
}
